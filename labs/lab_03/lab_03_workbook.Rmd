...
# A: 2, Hancock, GA and Galax City, VA
...
covid_county_jun_aug_pct_change <- covid_county_monthly_death_rate %>%
...
# Q: which Texas county had the smallest percentage change in cumulative case rate between May and August?
# A: Jones, TX
...
covid_county_jun_jul_pct_change <- covid_county_monthly_case_rate %>%
  select(county, state, d_2020_06_30, d_2020_07_30) %>%
  filter(state == "California") %>%
  mutate(jun_jul_pct_change = (d_2020_07_30 - d_2020_06_30)/d_2020_06_30) %>%
  arrange(desc(jun_jul_pct_change))

covid_county_jun_jul_pct_change

# Q: Which California county had the biggest percentage change in cumulative case rate between June and July?
# A: Colusa, CA
