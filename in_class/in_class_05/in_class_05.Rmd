...
* Q: Which state had the highest average number of deaths per county? What was that number? New Jersey,  759 death per county
* Q: Which state had the lowest average number of deaths per county? What was that number? 
Alaska, 1 death per county
